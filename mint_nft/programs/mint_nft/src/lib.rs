...
declare_id!("3UbRRdSwwQ6sZsbc5UAwed3fDFaXuKR4ikrxFnctVH3H");

#[program]
pub mod r08_anchor_mintnft {
    use super::*;
...
pub struct MintNFT<'info> {
    #[account(mut)]
    /// CHECK: We're about to craete this with Metaplex
    ...
    #[account(mut)]
    /// CHECK: We're about to craete this with Anchor
